...
def go_deps():
    ...
    go_repository(
        name = "com_github_henrydcase_nobs",
        importpath = "github.com/henrydcase/nobs",
        sum = "h1:UzltRpUK5PPlNYBBBc2ekotYJMIPjga7Wee8ADW3j+I=",
        version = "v0.0.0-20200305111951-7d891c7eb892",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:54MCo59c0pZwhJNai3b4jG/N4s0smpEXmMdfv9xObIE=",
        version = "v0.0.0-20200209152508-954a3ef2d564",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:81MfIApzizD8JqKIjnWy2Vxj7GgmQUrJlh/jYWH8yGk=",
        version = "v1.1.26",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:F7fM2kxXfuWw820fa+MMCCLH6hmYe+jtLnZpwoiLK4Q=",
        version = "v0.0.0-20200326210457-5d86d385bf88",
    )
    go_repository(
